...
OUTPUT_FILE = "/public/home/wangby2025/plusLab/outputs/test_2000_recall/best_eval_simi_37k_base.json"
...
def predict_relation(model, processor, image_path, subject_obj, object_obj, 
    ...
    query_text = f"{VLM_IMAGE_TOKENS[QWEN2_VL]} In the given image, the subject {subj_ref} is located at {subj_bbox_token},the object{obj_ref} is located at {obj_bbox_token}.Please describe the predicate relationship between the subject and the object as the subject is *predicate* the object."
...
def main():
    ...
    model_args = ModelArguments(
        ...
        checkpoint_path='/public/home/wangby2025/plusLab/outputs/sgg_qwen2vl_4_card_base_only_37k_simi/best_model_eval',
        pooling='last',
        normalize=True,
